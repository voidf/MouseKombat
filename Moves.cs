    ...
    private static MoveSet BuildCs()
    {
        ...
        var moves = new List<MoveDef>
        {
            ...
            new MoveDef {
                ...
                Hitbox = new Rect2(20, -210, 150, 110),
                CancelInto = new[] { "5HK" },
    ...
    private static MoveSet BuildDs()
    {
        ...
        var moves = new List<MoveDef>
        {
            ...
            new MoveDef {
                ...
                Hitbox = new Rect2(20, -280, 110, 240),
                Launches = true, // launcher: ground hit -> juggle
                MotionTimeline = new[] {
                    // startup crouch (0-5): tiny forward creep, still grounded
                    new MoveKey { From = 0,  To = 5,  PerFrame = new Vector2(0f,  0f) },
                    // launch/rise (6-13): shoot up & forward hard
                    new MoveKey { From = 6,  To = 6, PerFrame = new Vector2(8f, -30f) },
                    new MoveKey { From = 7,  To = 7, PerFrame = new Vector2(8f, -22f) },
                    new MoveKey { From = 8,  To = 8, PerFrame = new Vector2(8f, -20f) },
                    new MoveKey { From = 9,  To = 9, PerFrame = new Vector2(8f, -18f) },
                    new MoveKey { From = 10,  To = 10, PerFrame = new Vector2(8f, -14f) },
                    new MoveKey { From = 11,  To = 12, PerFrame = new Vector2(8f, -10f) },
                    new MoveKey { From = 13,  To = 14, PerFrame = new Vector2(4f, -9f) },
                    new MoveKey { From = 15,  To = 15, PerFrame = new Vector2(0f, -8f) },
                    new MoveKey { From = 16,  To = 17, PerFrame = new Vector2(0f, -7f) },
                    new MoveKey { From = 18,  To = 18, PerFrame = new Vector2(0f, -6f) },
                    new MoveKey { From = 19,  To = 19, PerFrame = new Vector2(0f, -5f) },
                    new MoveKey { From = 20,  To = 20, PerFrame = new Vector2(0f, -4f) },
                    new MoveKey { From = 21,  To = 21, PerFrame = new Vector2(0f, -3f) },
                    new MoveKey { From = 22,  To = 22, PerFrame = new Vector2(0f, -2f) },
                    new MoveKey { From = 23,  To = 23, PerFrame = new Vector2(0f, -1f) },
                    new MoveKey { From = 24,  To = 24, PerFrame = new Vector2(0f, 0f) },
                    new MoveKey { From = 25,  To = 25, PerFrame = new Vector2(0f, 0f) },
                    new MoveKey { From = 26,  To = 26, PerFrame = new Vector2(0f, 0f) },
                    new MoveKey { From = 27,  To = 27, PerFrame = new Vector2(0f, 0f) },
                    new MoveKey { From = 28,  To = 28, PerFrame = new Vector2(0f, 1f) },
                    new MoveKey { From = 29,  To = 29, PerFrame = new Vector2(0f, 2f) },
                    new MoveKey { From = 30,  To = 30, PerFrame = new Vector2(0f, 3f) },
                    new MoveKey { From = 31,  To = 31, PerFrame = new Vector2(0f, 4f) },
                    new MoveKey { From = 32,  To = 32, PerFrame = new Vector2(0f, 5f) },
                    new MoveKey { From = 33,  To = 33, PerFrame = new Vector2(0f, 6f) },
                    new MoveKey { From = 34,  To = 34, PerFrame = new Vector2(0f, 7f) },
                    new MoveKey { From = 35,  To = 35, PerFrame = new Vector2(0f, 8f) },
                    new MoveKey { From = 36,  To = 36, PerFrame = new Vector2(0f, 9f) },
                    new MoveKey { From = 37,  To = 37, PerFrame = new Vector2(0f, 10f) },
                    new MoveKey { From = 38,  To = 38, PerFrame = new Vector2(0f, 11f) },
                    new MoveKey { From = 39,  To = 39, PerFrame = new Vector2(0f, 12f) },
                    new MoveKey { From = 40,  To = 40, PerFrame = new Vector2(0f, 13f) },
                    new MoveKey { From = 41,  To = 41, PerFrame = new Vector2(0f, 14f) },
                    new MoveKey { From = 42,  To = 42, PerFrame = new Vector2(0f, 15f) },
                    new MoveKey { From = 43,  To = 43, PerFrame = new Vector2(0f, 16f) },
                    new MoveKey { From = 44,  To = 44, PerFrame = new Vector2(0f, 17f) },
                    new MoveKey { From = 45,  To = 45, PerFrame = new Vector2(0f, 18f) },
                    new MoveKey { From = 46,  To = 46, PerFrame = new Vector2(0f, 19f) },
                    new MoveKey { From = 47,  To = 47, PerFrame = new Vector2(0f, 20f) },
                    new MoveKey { From = 48,  To = 48, PerFrame = new Vector2(0f, 21f) },
                    new MoveKey { From = 49,  To = 49, PerFrame = new Vector2(0f, 22f) },
                    new MoveKey { From = 50,  To = 50, PerFrame = new Vector2(0f, 23f) },
                    new MoveKey { From = 51,  To = 51, PerFrame = new Vector2(0f, 24f) },
                    new MoveKey { From = 52,  To = 52, PerFrame = new Vector2(0f, 25f) },
                    // // apex (14-16): drift, gravity slows the climb
                    // new MoveKey { From = 14, To = 16, PerFrame = new Vector2(6f,  -6f) },
                    // // fall (17-25): come back down to the floor (engine snaps to ground on end)
                    // new MoveKey { From = 17, To = 25, PerFrame = new Vector2(4f,  30f) },
